...
update products set img = "http://localhost:3005/61a65b3999ddfa6baca6a725" where id = 1;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a765" where id = 2;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a745" where id = 3;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a747" where id = 4;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a74d" where id = 5;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a749" where id = 6;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a74b" where id = 7;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a751" where id = 8;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a74f" where id = 9;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a755" where id = 10;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a753" where id = 11;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a75f" where id = 12;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a757" where id = 13;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a759" where id = 14;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a75b" where id = 15;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a75d" where id = 16;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a761" where id = 17;
update products set img = "http://localhost:3005/61a667bd99ddfa6baca6a763" where id = 18;
